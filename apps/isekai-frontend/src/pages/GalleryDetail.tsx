      ...
      <PageHeader>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold tracking-tight">{folderName}</h1>
      ...
      <PageContent>
        ...
        {processedDeviations.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
                      <div className="absolute bottom-0 left-0 right-0 p-3">
                        ...
                        <p className="text-white/80 text-xs mt-1">{deviation.author.username}</p>
                      </div>
                    </div>
                  </a>
                ))}
          ...
          <div className="text-center py-16">
            <h3 className="text-lg font-semibold mb-2">No posts in this gallery</h3>
            <p className="text-muted-foreground mb-6 max-w-sm mx-auto">This gallery is empty.</p>
          </div>
        )}
      </PageContent>
    </PageWrapper>
