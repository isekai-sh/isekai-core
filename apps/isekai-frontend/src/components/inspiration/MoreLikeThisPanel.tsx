...
export function MoreLikeThisPanel({ deviation, open, onOpenChange }: MoreLikeThisPanelProps) {
            ...
            <div className="p-4 border-b">
              <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-medium text-sm line-clamp-2 mb-1">{deviation.title}</h3>
